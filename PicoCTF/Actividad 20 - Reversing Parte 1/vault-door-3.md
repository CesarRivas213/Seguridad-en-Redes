...
solo mostre la variable que traia la contraseña System.out.println(buffer);, y en el codigo se puede ver medio la contraseña , solo la colocas con un picoCTF y te la da
## Referencias
https://www.youtube.com/watch?v=rOmE3JYUlLY
